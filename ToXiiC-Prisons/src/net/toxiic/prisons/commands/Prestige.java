...
public class Prestige extends Util implements CommandExecutor {
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (args.length == 0) {
			...
			if (args[0].equalsIgnoreCase("set") && p.hasPermission("toxiicprisons.prestige.set")) {
			...
			if (args[0].equalsIgnoreCase("set") && p.hasPermission("toxiicprisons.prestige.set.other")) {

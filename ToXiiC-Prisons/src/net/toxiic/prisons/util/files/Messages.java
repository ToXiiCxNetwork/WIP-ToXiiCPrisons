package net.toxiic.prisons.util.files;
...
public class Messages {
	...
	public static void newDefault() {
		if (getData().get("Messages") == null) {
			...
			ArrayList<String> smelthelp = new ArrayList<String>();
			ArrayList<String> pickuphelp = new ArrayList<String>();
			
			help.add("&8----&aToXiiC &7AutoPickup&8----");
			help.add("&7\"toxiicdrops reload\" reloads the plugin");
			help.add("&7\"toxiicdrops debug\" will debug the plugin and output issues in console");
			
			smelthelp.add("----&aToXiiC &7AutoPickup&8----");
			smelthelp.add("&7\"autosmelt on\" toggles on");
			smelthelp.add("&7\"autosmelt off\" toggles off");
			
			pickuphelp.add("&8----&aToXiiC &7AutoPickup&8----");
			pickuphelp.add("&7\"autopickup on\" toggles on");
			pickuphelp.add("&7\"autopickup off\" toggles off");
			
			setData("Messages.reloadedconfig","Reloaded config");
			// Pickup
			setData("Messages.Pickup.AdminPickup.help",help);
			setData("Messages.Pickup.Smelt.help", smelthelp);
			setData("Messages.Pickup.AutoPickup.help", pickuphelp);
			
			setData("Messages.Pickup.nopermission","You do not have permission to use that command");
			setData("Messages.Pickup.fullinv","Your inventory is full. Dropping items on floor!");
			
			setData("Messages.Pickup.smelton","&aYou turned AutoSmelt on!");
			setData("Messages.Pickup.smeltison","&aAutoSmelt is already on!");
			setData("Messages.Pickup.smeltoff","&cYou turned AutoSmelt off!");
			setData("Messages.Pickup.smeltisoff","&cAutoSmelt is already off!");
			
			setData("Messages.Pickup.pickupon","&aYou turned AutoPickup on!");
			setData("Messages.Pickup.pickupon","&aAutoPickup is already on!");
			setData("Messages.Pickup.pickupoff","&cYou turned AutoPickup off!");
			setData("Messages.Pickup.pickupisoff","&cAutoPickup is already off!");
